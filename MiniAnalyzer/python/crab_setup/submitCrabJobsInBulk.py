...
# Global settings:
jobname = 'ntuple_testjob'
base_outdir = '/store/user/phazarik/EGM_photonID_crabdump'
...
for name, dataset in samples:
    ...
    outdir = os.path.join(base_outdir, jobname, name)
    ...
    # Main process line:
    processline = f'crab submit crab_cfg_basic.py {argument1} {argument2} {argument3} {argument4}'
